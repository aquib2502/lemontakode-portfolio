...
export default function ProblemHero({ onStartProject, onViewWork }) {
  return (
    <section id="hero" className="relative pt-32 md:pt-44 pb-20 md:pb-28 bg-[#111111] text-[#FFFFFF] overflow-hidden select-none border-b border-[#2A2A2A] min-h-[80vh] flex items-center">
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-12 relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <motion.h1
            ...
            className="lg:col-span-8 font-display text-4xl sm:text-6xl lg:text-[4.25rem] font-bold tracking-tight text-[#FFFFFF] leading-[1.05]"
          >
          ...
          >
            <p className="font-body text-base sm:text-lg text-[#D1D0C9] leading-relaxed">
            ...
            <div className="flex flex-wrap items-center gap-3.5 pt-2">
              <a
                ...
                className="btn-editorial-primary bg-[#FFFFFF] text-[#111111] hover:bg-[#F7F5F0] border-[#FFFFFF] hover:border-[#D9A74A]"
              >
              ...
              <a
                href="#work"
                onClick={onViewWork}
                className="btn-editorial-secondary bg-transparent text-[#FFFFFF] border-[#444444] hover:border-[#2563EB] hover:text-[#FFFFFF] hover:bg-white/10"
              >
